...
function WOG_in_Excel(data) {
  ...
  Excel(wsData, "Wrk_with_object_type_and _group");
}
...
function CreatingConditionExcel(data2) {
  ...
  /* Create a worksheet */
  Excel(wsData, "One_on_One_Condition");
}
...
function generateXMLConditions() {
  ...
  if (!click) {
    click = true;
    prefixName = window.prompt("Please enter your prefix Name like G5_");
  }
